...
```bash
$count = true //toplam kayit sayisini göster
$top = 10 //kaç kayit alinacagini
$skip = 0 //kaç kayit atlanacagi
$select = Name //hangi alanlarýn alinacagini
$orderby = Name //neye göre siralayacagini
$expand = Category // join yapilacak tablo
```
